...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const CATEGORIES = {
    ...
    bans: ['ban_create', 'ban_revoke'],
    support: ['support_open', 'support_status', 'support_delete', 'support_block', 'support_unblock', 'image_delete', 'image_cleanup'],
    ...
    settings: ['panel_update', 'applications_open', 'applications_pause', 'result_template_update', 'discord_invite_update',
      'site_update', 'setup_result_channel', 'setup_apply', 'setup_support_channel'],
